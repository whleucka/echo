...
#[AsCommand(name: 'migrate:down', description: 'Run down method on specific migration files')]
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($files as $basename) {
            if (array_key_exists($basename, $migrationFiles)) {
                $this->migrationDown($migrationFiles[$basename]);
                $output->writeln("<info>Rolled back: $basename</info>");
            } else {
